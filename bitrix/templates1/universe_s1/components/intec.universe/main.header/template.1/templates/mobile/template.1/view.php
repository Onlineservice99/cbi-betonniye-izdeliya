                ...
                <?php if ($arResult['SEARCH']['SHOW']['MOBILE']) { ?>
                    ...
                    <?php } else { ?>
                        <div style="display: flex;align-items: center;">
                            ...
                            <div class="menu-item-icon-wrap intec-grid-item-auto" style="padding:0px 10px;">
                                <a href="tel:/79201279887" style="display: flex;">
                                    <div class="menu-item-icon intec-cl-text" style="color: #ffffff !important;font-size: 20px;">
                                        <i class="fas fa-phone fa-flip-horizontal"></i>
                                    </div>
                                </a>
                            </div>
                            <div class="widget-search-wrap intec-grid-item-auto" style="padding:0px 10px;">
