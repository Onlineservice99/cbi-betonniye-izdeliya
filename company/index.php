...
/* Адаптивность */
@media (max-width: 768px) {
    .overlay-card {width: 223px;height: 169px;top:27%;}
		...
		<div class="intec-content-wrapper">
			...
			<div class="grid">
				<div class="feature" data-aos="zoom-in">
					...
					<h3>ColorMix Technology</h3>
					<p>Использование технологии «ColorMix» при производстве тротуарной плитки. Эта технология позволяет создавать плитку в актуальных пастельных тонах с возможностью комбинирования различных цветовых решений.</p>
				</div>
				<div class="feature" data-aos="zoom-in" data-aos-delay="100">
					<div class="feature-icon">🔍</div>
					<h3>Контроль качества</h3>
					<p>Контроль на всех этапах производства, начиная от подбора сырья и заканчивая готовой продукцией, что позволяет гарантировать стабильно высокое качество и долгий срок службы материалов.</p>
				</div>
				<div class="feature" data-aos="zoom-in" data-aos-delay="200">
					<div class="feature-icon">🚚</div>
					<h3>Логистика</h3>
					<p>Благодаря развитой логистической системе и наличию продукции на складе, компания обеспечивает быструю отгрузку заказов.</p>
				</div>
				<div class="feature" data-aos="zoom-in" data-aos-delay="200">
					<div class="feature-icon">💰</div>
					<h3>Конкурентные цены</h3>
					<p>Собственное производство дает возможность поддерживать конкурентоспособные цены, сохраняя при этом высокие стандарты. Это делает продукцию доступной для широкого круга клиентов — от частных застройщиков до крупных строительных компаний.</p>
				</div>
				<div class="feature" data-aos="zoom-in" data-aos-delay="200">
					<div class="feature-icon">📦</div>
					<h3>Гибкие заказы</h3>
					<p>Возможность дозаказа недостающих материалов в штучном варианте, в отличие от конкурентов, которые часто требуют закупку только целыми поддонами. Такой подход не только удобен для клиентов, но и позволяет значительно сэкономить, делая сотрудничество с компанией еще более выгодным и привлекательным.</p>
				</div>
				<div class="feature" data-aos="zoom-in" data-aos-delay="200">
					<div class="feature-icon">📜</div>
					<h3>Сертификация ГОСТ</h3>
					<p>Сертификация продукции в соответствие с ГОСТ</p>
				</div>
			</div>
		</div>
	</div>
