...
<?= Html::beginTag('div', [
	...
	array(
		...
		"ADDRESS" => "г. Рыбинск, ул. Окружная дорога, дом 24А",
		"EMAIL" => "rodionmx226@gmail.com",
		"TAGLINE" => "Цех бетонных изделий",
		...
		"BANNER_PRODUCT_PROPERTY_MARKS_SHARE" => "",
		"SECOND_PHONES_SHOW" => "N",
		"SOCIAL_SQUARE" => "N",
		"SOCIAL_GREY" => "N",
		"AUTHORIZATION_FORM_USE_REGISTRATION" => "N",
		"SEARCH_HIDE_REQUESTED" => "N",
		"SEARCH_REQUESTED_IBLOCK_ID_TYPE" => "",
		"SEARCH_REQUESTED_IBLOCK_ID" => "1",
		...
		"BANNER_MOBILE_BLOCK_SEPARATED" => "N",
		"BANNER_HEADER_H1" => "N",
